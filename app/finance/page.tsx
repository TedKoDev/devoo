...
export default function FinancePage() {
  ...
  const stockMarket = getMockStockMarkets()
  const globalIssues = getMockGlobalIssues()
  ...
  return (
    <div className="py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <StockMarketWidget data={stockMarket} />
            ...
            <dl className="space-y-2 text-sm">
              <div>
                ...
                <dd className="text-gray-500">
                  주가를 주당순이익으로 나눈 값으로, 기업의 수익 대비 주가 수준을 평가하는 지표
                </dd>
              </div>
              <div>
            ...
            <div className="space-y-3 text-sm">
              <div>
                ...
                <p className="text-gray-500">
                  한국은행 금융통화위원회가 기준금리를 현 수준에서 동결하기로 결정했습니다.
                </p>
              ...
              <div>
                ...
                <p className="text-gray-500">
                  최근 국내 주택시장에서 거래량이 소폭 증가하며 회복 조짐을 보이고 있습니다.
                </p>
