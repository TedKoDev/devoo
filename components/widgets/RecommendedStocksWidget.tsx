      ...
      <div className="flex space-x-2 mb-3">
        <button
          ...
          className={`px-3 py-1 text-xs rounded-md ${
            activeTab === "korean" ? "bg-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
          }`}
        >
          한국 증시
        </button>
        <button
          ...
          className={`px-3 py-1 text-xs rounded-md ${
            activeTab === "us" ? "bg-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"
          }`}
        >
          미국 증시
        </button>
          ...
          <div key={stock.symbol} className="flex justify-between items-center text-sm">
            ...
            <div className="flex flex-col items-end">
              <span className="font-medium">
                {activeTab === "korean" ? `${stock.price.toLocaleString()}원` : `$${stock.price.toLocaleString()}`}
              </span>
